...
//		if (j < r)
//		{
//			printf("d=%d 是 k=%d 的 左孩子", j, r);
//			//cout << "d" << j << "是" << "k" << r << "的左孩子" << endl;
//		} 
//		else 
//		{
//			printf("d=%d 是 k=%d 的 右孩子", j, r);
//			//cout << "d" << j << "是" << "k" << r << "的 右孩子" << endl;
//		}
//		return;
//	}
//	else//遇到内部结点
...
//		if (rootChild < r)
//		{
//			printf("k=%d 是 k=%d 的 左孩子", rootChild, r);
//			//cout << "k" << rootChild << "是" << "k" << r << "的 左孩子" << endl;
//		}
//		else {
//			printf("k=%d 是 k=%d 的 右孩子", rootChild, r);
//			//cout << "k" << rootChild << "是" << "k" << r << "的 右孩子" << endl;
//		}
//	}
//
//	printOptimalBST(i, rootChild - 1, rootChild);
