...
class CAlgorithm : public ::testing::Test {
public:
    CAlgorithm() : Test() {
        std::cout << std::endl;
...
/*** 整形反序 ***/
TEST_F(CAlgorithm, test_reverse) {
...
TEST_F(CAlgorithm, test_findDuplicates) {
...
//查找最长的回文子字符串
TEST_F(CAlgorithm, test_longestPalindrome) {
...
//合并两个有序链表
TEST_F(CAlgorithm, test_mergeTwoLists) {
...
//移除链表中倒数第二个节点
TEST_F(CAlgorithm, test_removeNthFromEnd) {
...
//成对交换相邻的两个节点
TEST_F(CAlgorithm, test_swapPairs) {
